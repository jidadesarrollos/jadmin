            ...
            <div class="col-12">
                <form action="<?= \Jida\Manager\Estructura::$urlBase ?>/jadmin/usuario/perfil/<?= $this->id_usuario ?>"
                    ...
                    <div class="form-group text-right">
                        <button type="submit" name="btnGestionPerfiles" class="btn btn-primary"
                                value="true"><?= $this->texto('btnSave') ?></button>
                        <a href="<?= \Jida\Manager\Estructura::$urlBase ?>/jadmin/usuario/"
                           class="btn btn-primary"><?= $this->texto('btnBack') ?></a>
                    </div>
                </form>
            </div>
        </div>
